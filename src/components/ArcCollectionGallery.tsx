        ...
        {ARC_COLLECTION.map((item) => (
          ...
          >
            ...
            <div className="p-4">
              ...
              {!CONTRACT_ADDRESSES.GIFT_CARD_MINTER || CONTRACT_ADDRESSES.GIFT_CARD_MINTER === '' ? (
                <div className="w-full px-4 py-2 bg-gray-300 text-gray-600 rounded-lg text-center text-sm">
                  Mint não disponível
                </div>
              ) : (
                <button
